...
{
   private final SparkMax liftMotor = new SparkMax(Constants.OperatorConstants.LiftMotor, MotorType.kBrushed); // Change the ID to match your setup
  ...
  private void setupAutonomous() {
    ...
    private void registerCommands() {
        NamedCommands.registerCommand("L4elevator", Commands.runOnce(() -> new L4elevator(liftMotor, 0.5, 6000).schedule()));
        NamedCommands.registerCommand("AutonomousCommand",Commands.runOnce(() -> new AutonomousCommand(liftMotor).schedule()));
        NamedCommands.registerCommand("test", Commands.print("I EXIST"));
...
public Command getAutonomousCommand(String pathName) {
    return new SequentialCommandGroup(
        ...
        NamedCommands.getCommand("L4elevator"),
        NamedCommands.getCommand("AutonomousCommand")
    );
}
